// Lightweight GSAP helpers
// Expects GSAP + ScrollTrigger loaded globally from CDN
...
export const initParallaxLayers = (containerSelector) => {
...
export const initCharacterTilt = (selector) => {
...
export const initScrollRevealSections = () => {
...
export const initFloatingParticles = (selector) => {
